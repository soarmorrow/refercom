...
============================== -->
<!-- BOOTSTRAP -->
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/bootstrap.min.css')}}">

<!-- FONT ICONS -->
<!-- IonIcons -->
<link rel="stylesheet" href="{{URL::asset('assets/assetsIndex/ionicons/css/ionicons.css')}}">
...
<!-- Elegant Icons -->
<link rel="stylesheet" href="{{URL::asset('assets/assetsIndex/elegant-icons/style.css')}}">
<!--[if lte IE 7]><script src="assets/elegant-icons/lte-ie7.js')}}"></script><![endif]-->



<!-- CAROUSEL AND LIGHTBOX -->
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/owl.theme.css')}}">
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/owl.carousel.css')}}">
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/nivo-lightbox.css')}}">
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/nivo_themes/default/default.css')}}">

<!-- COLORS -->
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/colors/maroon.css')}}">
<!-- <link rel="stylesheet" href="{{URL::asset('assets/cssIndex/colors/blue.css')}}"> --> <!-- DEFAULT COLOR/ CURRENTLY USING -->
...
<!-- CUSTOM STYLESHEETS -->
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/styles.css')}}">

<!-- RESPONSIVE FIXES -->
<link rel="stylesheet" href="{{URL::asset('assets/cssIndex/responsive.css')}}">
	...
	<div class="navigation-header">
		...
		<div class="navbar navbar-inverse bs-docs-nav navbar-fixed-top sticky-navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img src="{{URL::asset('assets/images/logo-login.png')}}" alt=""></a>
		...
		<div class="navbar non-sticky">
			...
			<div class="container">
				...
				<div class="navbar-header">
					<img src="{{URL::asset('assets/images/Logo_type.png')}}" alt="">
				</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 intro-section">
				<a href="{{ route('signin') }}" class="btn" style="background:#800000;color:white" role="button">Sign In</a>
                
                	 <a href="{{ route('signup') }}" class="btn" style="color:white"  role="button">Sign up</a>
				
				<h1 class="intro">
				Streamline the hunt <!-- <span class="strong colored-text">Solution</span> for Your <strong>Business</strong> -->
				</h1>
				...
				<p class="sub-heading">
				   ...
				   Referecom’s Individual and business accounts for efficient talent management
				</p>
			<a href="#myModal" id="uniq" role="button"  data-toggle="modal" class="btn btn-lg btn-success">Get Application</a>
				<div style="display:none" class="uniqueDiv">
	            	
	            	<br>
	            	<br>
	            	   <form id="uniqueForm" method="get" action="{{URL::route('getpublicform')}}">
                      <input type="text" name="uniqueid" class="center-block input-sm" />
                      {{Form::token()}}
                      <br>
                      <input type="submit" class="btn btn-success btn-large" value="GET" />
                      </form>
		        </div>
        ...
        @include('frontend/notifications')
				...
				<a href="{{ route('signin') }}" class="btn standard-button">Business</a>
				<a href="{{ route('signin') }}" class="btn secondary-button-white">Individual</a>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="side-screenshot pull-left">
				<img src="{{URL::asset('assets/imagesIndex/image-1.jpg')}}" alt="Feature" class="img-responsive">
			</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="side-screenshot2 pull-right">
				<img src="{{URL::asset('assets/imagesIndex/image-2.jpg')}}" alt="Feature" class="img-responsive">
			</div>
		</div>
...
<div class="container">
	...
	<div class="row screenshots">
		...
		<div id="screenshots" class="owl-carousel owl-theme">
			...
			<div class="shot">
				<a href="{{URL::asset('assets/imagesIndex/screenshots/1.jpg')}}" data-lightbox-gallery="screenshots-gallery"><img src="{{URL::asset('assets/imagesIndex/screenshots/1.jpg')}}" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="{{URL::asset('assets/imagesIndex/screenshots/3.jpg')}}" data-lightbox-gallery="screenshots-gallery"><img src="{{URL::asset('assets/imagesIndex/screenshots/3.jpg')}}" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="{{URL::asset('assets/imagesIndex/screenshots/2.jpg')}}" data-lightbox-gallery="screenshots-gallery"><img src="{{URL::asset('assets/imagesIndex/screenshots/2.jpg')}}" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="{{URL::asset('assets/imagesIndex/screenshots/4.jpg')}}" data-lightbox-gallery="screenshots-gallery"><img src="{{URL::asset('assets/imagesIndex/screenshots/4.jpg')}}" alt="Screenshot"></a>
			</div>
	...
	<div class="row clients">
		<div class="col-md-12 col-sm-12">
			<ul class="client-logos">
				<li><a href=""><img src="{{URL::asset('assets/imagesIndex/clients/1.png')}}" alt=""></a></li>
				<li><a href=""><img src="{{URL::asset('assets/imagesIndex/clients/2.png')}}" alt=""></a></li>
				<li><a href=""><img src="{{URL::asset('assets/imagesIndex/clients/3.png')}}" alt=""></a></li>
				<li><a href=""><img src="{{URL::asset('assets/imagesIndex/clients/4.png')}}" alt=""></a></li>
			</ul>
		</div>
	</div>
		...
		<div id="feedbacks" class="owl-carousel owl-theme">
			...
			<div class="single-feedback">
				<div class="client-pic">
					<img src="{{URL::asset('assets/imagesIndex/client-pics/1.jpg')}}" alt="">
				</div>
				<div class="box">
					<p class="message">
			...
			<div class="single-feedback">
				<div class="client-pic">
					<img src="{{URL::asset('assets/imagesIndex/client-pics/2.jpg')}}" alt="">
				</div>
				<div class="box">
					<p class="message">
						 Lorem lean startup ipsum product market fit customer development acquihire technical cofounder. User engagement A/B testing shrink a market venture capital pitch deck. Social bookmarking group buying crowded market pivot onboarding.
			...
			<div class="single-feedback">
				<div class="client-pic">
					<img src="{{URL::asset('assets/imagesIndex/client-pics/3.jpg')}}" alt="">
				</div>
				<div class="box">
					<p class="message">
						 Lorem lean startup ipsum product market fit customer development acquihire technical cofounder. User engagement A/B testing shrink a market venture capital pitch deck. Social bookmarking group buying crowded market pivot onboarding.
...
<div class="container">
	...
	<div class="footer-logo">
		<img src="{{URL::asset('assets/images/logo-login.png')}}" height="70px" width="140px" alt="">
	</div>
...
<!-- =========================
     SCRIPTS   
============================== -->
<script src="{{URL::asset('assets/jsIndex/jquery.min.js')}}"></script>
...
<script src="{{URL::asset('assets/jsIndex/bootstrap.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/retina-1.1.0.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/smoothscroll.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/jquery.scrollTo.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/jquery.localScroll.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/owl.carousel.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/nivo-lightbox.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/simple-expand.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/jquery.nav.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/jquery.fitvids.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/jquery.ajaxchimp.min.js')}}"></script>
<script src="{{URL::asset('assets/jsIndex/custom.js')}}"></script>
<!-- ****************
