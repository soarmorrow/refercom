...
@if(isset($fields))
  @foreach($fields as $f)
    ...
    <!-- <div class="col-sm-3 cf-item">
                <header>
                    <h4><span></span>Experience in Years[{{$f->label}}]</h4>
                </header>
                <div class="content">
                    <div class="cf-svmc">
                        <div class="metric">{{$op}}</div>
                        <div class="change m-amber metric-small" style="display:none">
...
<div class="clearfix"></div>
  @foreach($seeker as $s)
    ...
    @if(isset($s->rank))
          ...
          <div class="col-sm-3 cf-item">
                <header>
                    <h4><span></span>Rank</h4>
                </header>
                <div class="content cf-svp clearfix" id="svp-{{$l}}">
                    <div class="chart" data-percent="{{(($s->rank)/5)*100}}" data-layout="l-6-12-6"></div>
                    <div class="metrics">
                        <span class="metric">{{(($s->rank)/5)*100}}</span>
                        <span class="metric-small"></span>
                    </div>
                </div>
            </div> <!-- //end cf-item -->
