...
class FormTemplateController extends AdminController {
	...
	{
		// Grab all the users
		$forms = FormTemplates::get();

		var_dump($forms);

		// Show the page
		return View::make('backend/form_templates/index', compact('users'));
	}
	...
	public function getCreate()
	{
		...
		// var_dump($types);
		// Show the page
		return View::make('backend/form_templates/create', compact('types'));
	}
	...
	public function postCreate()
	{
		...
		$validator = Validator::make(Input::all(), FormTemplates::$rules);
