...
var FormBuilder = function ($) {
    ...
    $(function () {
      ...
      $('#inputs').load(baseUrl+'/components/inputs', function() {
        $('#radioscheckboxes').load(baseUrl+'/components/radioscheckboxes', function() {
          $('#select').load(baseUrl+'/components/select', function() {
            $('#other').load(baseUrl+'/components/other', function() {
